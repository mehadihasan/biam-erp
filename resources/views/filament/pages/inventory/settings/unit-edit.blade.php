<x-filament-panels::page>
    ...
    <div class="space-y-4">
        <div>
            <h2 class="text-xl font-bold text-gray-950 dark:text-white">Edit Unit</h2>
        </div>
        ...
        <form method="post" action="{{ route('inventory.units.update', $unit) }}" class="inventory-form">
            @csrf
            @method('put')
            ...
            <div class="inventory-form__grid">
                <label class="inventory-form__field">
                    ...
                    <input name="name" type="text" value="{{ old('name', $unit->name) }}" class="inventory-form__control">
                ...
                <label class="inventory-form__field inventory-form__field--wide">
                    <span>Details</span>
                    <textarea name="details" rows="4" class="inventory-form__control">{{ old('details', $unit->details) }}</textarea>
