<x-filament-panels::page>
    ...
    <div class="space-y-6">
        <div>
            <h2 class="text-3xl font-bold leading-tight text-gray-950 dark:text-white">Edit Supplier</h2>
        ...
        <form method="post" action="{{ route('inventory.suppliers.update', $supplier) }}" class="supplier-form">
            @csrf
            @method('put')
            ...
            <div class="supplier-form__actions">
                <button class="supplier-form__button">Update Supplier</button>
