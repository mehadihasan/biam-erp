<x-filament-panels::page>
    ...
    <div class="space-y-4">
        <div>
            <h2 class="text-xl font-bold text-gray-950 dark:text-white">Create Category</h2>
        </div>
        ...
        <form method="post" action="{{ route('inventory.categories.store') }}" class="inventory-form">
            @csrf
