<x-filament-panels::page>
    <style>
        ...
        select.designation-form__control {
            height: 42px;
        }
        ...
        .designation-form__checkbox input {
            width: 16px;
            height: 16px;
        ...
        .dark .designation-form__checkbox {
            color: #ffffff;
        }
    ...
    <div class="space-y-4">
        <div>
            <h2 class="text-xl font-bold text-gray-950 dark:text-white">Create Designation</h2>
        </div>
        ...
        <form method="post" action="{{ route('designations.store') }}" class="designation-form">
            @csrf
            ...
            <div class="designation-form__grid">
                <label class="designation-form__field">
                    ...
                    <input name="name" type="text" value="{{ old('name') }}" class="designation-form__control">
                ...
                <label class="designation-form__field designation-form__field--wide">
                    ...
                    <textarea name="description" rows="4" class="designation-form__control">{{ old('description') }}</textarea>
                    @error('description') <span class="designation-form__error">{{ $message }}</span> @enderror
                </label>
            </div>

            <div class="designation-form__actions">
                <button class="designation-form__button">Save</button>
