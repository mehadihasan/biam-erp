...
<aside class="bcs-sidebar" aria-label="{{ __('Portal navigation') }}">
    <nav class="bcs-sidebar__nav">
        <a href="{{ route($portalRoutePrefix.'.booking') }}" class="bcs-sidebar__link{{ $activeMenu === 'booking' ? ' bcs-sidebar__link--active' : '' }}">
        ...
        <a href="{{ route($portalRoutePrefix.'.meals') }}" class="bcs-sidebar__link{{ $activeMenu === 'meal' ? ' bcs-sidebar__link--active' : '' }}">
            <span class="bcs-sidebar__icon" aria-hidden="true">
        ...
        <a href="{{ route($portalRoutePrefix.'.feedback') }}" class="bcs-sidebar__link{{ $activeMenu === 'feedback' ? ' bcs-sidebar__link--active' : '' }}">
            <span class="bcs-sidebar__icon" aria-hidden="true">
        ...
        <a href="{{ route($portalRoutePrefix.'.billing') }}" class="bcs-sidebar__link{{ $activeMenu === 'billing' ? ' bcs-sidebar__link--active' : '' }}">
            <span class="bcs-sidebar__icon" aria-hidden="true">
